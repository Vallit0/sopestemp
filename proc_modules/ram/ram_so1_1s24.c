...
MODULE_AUTHOR("Estuardo Sebastian Valle Bances");
...
{
    proc_create("ram_202001954", 0, NULL, &operaciones);
    printk(KERN_INFO "Estuardo Sebastian Valle Bances\n");
    return 0;
}
...
{
    remove_proc_entry("ram_202001954", NULL);
