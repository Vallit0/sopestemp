              ...
              <Col sm={8}>
                <Card.Text as="div">
                  <Row className="mb-2">
                    ...
                    <Col sm={4}>
                      <Button variant="outline-primary" size="sm" onClick={editProfile}>Editar Perfil</Button>
                    </Col>
                  </Row>
                  <Row>
                    <Col sm={8}>
                ...
                <div className="mt-4">
                  <Button variant="outline-secondary" size="sm" onClick={editAlbums} className="me-2">Editar Álbumes</Button>
                </div>
              </Col>
            </Row>
          </Card.Body>
